...
# Create a Streamlit web application for Fraud Detection
st.title("Fraud Detection dashboard")

# Slider to adjust the threshold for classifying predictions
...
# Input boxes for cost, then display total cost of fraud
...
# Calculate the default costs based on the default threshold (0.50)
tp_default = 0
fp_default = 0
fn_default = 0
tn_default = 0
...
# Display metrics using DataFrames
st.dataframe(metrics.assign(hack="").set_index("hack"))

# Display the metrics for the default threshold
